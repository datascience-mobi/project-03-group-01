...
def image_prepare(path) -> list:
    ...
    # creates black canvas of 28x28 pixels
    ...
    if width > height:
        ...
        new_image.paste(img, (w_left+4, 4))  # paste resized image on black canvas
...
if __name__ == '__main__':
    ...
    image_operations.draw(image_prepare_old("mnist.png"))
